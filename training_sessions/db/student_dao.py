def insert_student_random(number=10):
    for num in range(10):
        query = "INSERT INTO student (id, name, age) VALUES(" + str(num) + ", 'name_" + str(num) + "', " + str(
            num) + "); "
        print(query)
    for num in range(10):
...
if __name__ == '__main__':
    ...
    con = db_connection.Db.get_connection()
    query = insert_student({'id':1, 'name':"updated_name_24"})
    cursor = con.cursor()
